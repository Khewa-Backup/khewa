          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              {if $cart.subtotals.shipping.value}
                <p><span>{l s='Shipping:' d='Shop.Theme.Checkout'}</span>&nbsp;<span class="shipping value"> {if {$cart.subtotals.shipping.value} != 'Free'} {$cart.subtotals.shipping.value}{/if} {hook h='displayCheckoutSubtotalDetails' subtotal=$cart.subtotals.shipping}</span></p>
              {/if}
