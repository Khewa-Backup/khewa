...
class CustomerSyncCommand extends BaseApiCommand
{
    ...
    protected function buildCustomers()
    {
        ...
        $originalUpdateSubscriptionStatus = $this->updateSubscriptionStatus;

        foreach ($this->customerIds as $customerId) {
            $this->updateSubscriptionStatus = $originalUpdateSubscriptionStatus;
