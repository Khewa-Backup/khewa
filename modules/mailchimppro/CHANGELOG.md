...
*  fixed mispelling 
*  fixed mispelling 
*  vue dependency local 
*  build update 
*  axios fix - loaded locally 
*  library path dynamic 
*  axios fix 
*  axios license fix 
...
*  fixing cron channel 
*  version 3.0.28 
*  mcjs script modifications fix 
*  version bump 
*  script load 
*  build trigger 
*  maichimp script modification 
*  render in smarty tpl 
*  build trigger 
*  modifications in preprocessing 
*  mcjs fetch tpl modifications for validation 
*  footer script load removed 
*  build trigger for PS 1.6 
*  release ps16 
*  PS16 auto build 
*  auto build ps17-9 
*  ps9 build 
*  build master ps9 
*  ps 16 build - zip difference 
*  product status quick change fix 
*  verison bump 
*  product status quick change fix 
*  removed unnecessary comments 
*  only batch logging 
*  version bump 
*  truncate cronjob log file 
*  exclude .md files from build 
*  json_decode fix PHP 8.1 
*  version update 
*  customer tag no name issue + part deleted order issue 
*  version update 
*  separate queue add methods 
*  version bump +  build trigger 
*  style modification 
*  design fix 
*  Invalid api key check 
*  subscribed override fix 
*  newsletter double opt in in prestashop 
*  version bump 
*  gitignore update 


## latest-ps16 (2025-10-08)
