            ...
            <table id="promoTable" class="table table-striped table-bordered">
                ...
                {foreach from=$promos item=promo}
                    <tr data-id="{$promo.id|escape:'htmlall':'UTF-8'}">
                        ...
                        <td>{if $promo.reduction}{$promo.reduction|escape:'htmlall':'UTF-8'} {if $promo.reduction_type == 1}%{else}{$currency->sign|escape:'htmlall':'UTF-8'}{/if}{/if}</td>
                        ...
                        <td>
                            <button class="btn btn-xs btn-default view-promo-group"
                                    v-on:click="viewPromo({$promo.id|escape:'htmlall':'UTF-8'})" title="View">
                                <i class="icon icon-zoom-in" aria-hidden="true"></i>
                            </button>
                            <button class="btn btn-xs btn-default edit-promo-group"
                                    v-on:click="editPromo({$promo.id|escape:'htmlall':'UTF-8'})" title="Edit">
                                <i class="icon icon-edit" aria-hidden="true"></i>
                            </button>
                            <button class="btn btn-xs btn-default edit-promo-group"
                                    v-on:click="viewPromoStats({$promo.id|escape:'htmlall':'UTF-8'})" title="Stats">
                                <i class="icon icon-pie-chart"></i>
                            </button>
                            <button class="btn btn-xs btn-danger delete-promo-group"
                                    v-on:click="deletePromo({$promo.id|escape:'htmlall':'UTF-8'})" title="Delete">
    ...
    <div class="panel-body">
        <div class="form-horizontal new-promo-container">
            ...
            <div class="form-group promo-expiration-step">
                ...
                <div class="col-lg-5">
                    <input type="text" class="input-medium" name="PROMO_EXPIRATION" id="PROMO_EXPIRATION" required="required" value="{$defaultDate|escape:'htmlall':'UTF-8'}">
            ...
            <div class="generate-promo-codes form-group" style="display: none;">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="col-lg-10">
                        <div class="col-lg-12">
                            {l s='Expected total number of promo codes:' mod='mailchimppro'} <span class="" id="totalCodes">{$totalCodes|escape:'htmlall':'UTF-8'}</span>
                        </div>
                        <div class="col-lg-12">
