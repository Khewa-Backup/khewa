...
class PrestaHelper {
	...
	public $headers, $body;
	public static $id_content_global,$id_content_primary_global,$id_editor_global, $hook_current, $id_lang_global, $id_shop_global, $disable_activity, $current_error, $isprdlayout;
	...
	public static function setPreviewForHook( $hook ) {
		...
		if ( $hook == 'displayLeftColumn' ) {
			...
			$id = Tools::getValue('id');
			$preview = Context::getContext()->link->getModuleLink( 'crazyelements', 'prdlayouts',  array('id_crazyprdlayouts' => $id,'hook' => 'prdlayouts','id_lang' => $id_lang) , null, self::$id_lang_global );
