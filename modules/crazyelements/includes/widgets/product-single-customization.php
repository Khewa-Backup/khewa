...
class Widget_ProductSingleCustomization extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        if ($controller_name == "product") {
            ...
            $out_put .= \Context::getcontext()->smarty->fetch(_PS_MODULE_DIR_ . 'crazyelements/views/templates/front/crazy_single_product_customization.tpl');
            echo $out_put;
        } else {
            echo 'Here will be Customization';
        }
    }
