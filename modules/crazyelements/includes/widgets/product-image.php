...
class Widget_ProductImage extends Widget_Base {
	...
	protected function render() {
		...
		if($controller_name == "product"){
			...
			$out_put .= \Context::getcontext()->smarty->fetch(_PS_MODULE_DIR_ . 'crazyelements/views/templates/front/crazy_single_product_image.tpl');
			echo $out_put;
		}else{
			echo '<img src="'.Utils::get_placeholder_image_src().'" alt="Product Placeholder" width="458" height="458" loading="lazy">';
		}
