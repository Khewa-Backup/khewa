...
<p><strong>{l s='This module allows you to accept payments by Virtual Merchant.' mod='virtualmerchant'}</strong></p>
<p>{l s='If the customer chooses this payment method, your Virtual Merchant account will be automatically credited.' mod='virtualmerchant'}</p>
<p>{l s='You need to configure your Virtual Merchant account first before using this module.' mod='virtualmerchant'}</p>
</div>
