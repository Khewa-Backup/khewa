...
<div class="elegantalBootstrapWrapper">
    <div class="panel">
        <div class="panel-heading">
            <i class="icon-image"></i> SEO Image Alt Tag Rules
        </div>
        <div class="panel-body">
            <div class="row elegantal_panel elegantal_imagealt_apply_panel" data-id="{$model->id_elegantalseoessentials_image_alt|intval}" data-lang="{$lang_id|intval}" data-offset="{$offset|intval}" data-limit="{$limit|intval}" data-requests="{$requests|intval}" data-reloadmsg="{l s='The process has not finished yet.' mod='elegantalseoessentials'}">
