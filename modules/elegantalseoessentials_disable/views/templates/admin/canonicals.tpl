...
<div class="elegantalBootstrapWrapper">
    <div class="panel">
                                ...
                                <tr>
                                    <td>
                                        <a href="{$shop_url|escape:'html':'UTF-8'}{$model.old_url|escape:'html':'UTF-8'}" target="_blank">
                                            {$shop_url|escape:'html':'UTF-8'}{$model.old_url|truncate:30:'...'|escape:'html':'UTF-8'}
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{$shop_url|escape:'html':'UTF-8'}{$model.new_url|escape:'html':'UTF-8'}" target="_blank">
                                            {$shop_url|escape:'html':'UTF-8'}{$model.new_url|truncate:30:'...'|escape:'html':'UTF-8'}
                                        </a>
                                    </td>
        ...
        <div class="panel-footer clearfix">
            <a href="{$adminUrl|escape:'html':'UTF-8'}&event=canonicalEdit" class="btn btn-success pull_right">
                <i class="process-icon-new"></i> {l s='Add New' mod='elegantalseoessentials'}
            </a>
            {if $models}
                <a href="{$adminUrl|escape:'html':'UTF-8'}&event=canonicalDeleteAll" class="btn btn-default pull_right" onclick="return confirm('{l s='Are you sure?' mod='elegantalseoessentials'}')">
                    <i class="process-icon-delete"></i> {l s='Delete All' mod='elegantalseoessentials'}
                </a>
            {/if}
            <a href="{$adminUrl|escape:'html':'UTF-8'}&event=editSettingsCanonical" class="btn btn-default pull_left">
