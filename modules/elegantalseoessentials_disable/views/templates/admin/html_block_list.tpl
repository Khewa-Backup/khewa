...
<div class="elegantalBootstrapWrapper">
    <div class="panel elegantal_panel">
        ...
        <div class="panel-footer clearfix">
            <a href="{$adminUrl|escape:'html':'UTF-8'}&event=htmlBlockUpdate" class="btn btn-success pull_right">
                <i class="process-icon-new"></i> {l s='New HTML Code' mod='elegantalseoessentials'}
            </a>
            <a href="{$adminUrl|escape:'html':'UTF-8'}&event=htmlBlockUpdate&twitter_cards=1" class="btn btn-default pull_right">
                <i class="process-icon-twitter"></i> {l s='Twitter Cards' mod='elegantalseoessentials'}
            </a>
            <a href="{$adminUrl|escape:'html':'UTF-8'}&event=htmlBlockUpdate&facebook_tags=1" class="btn btn-default pull_right">
