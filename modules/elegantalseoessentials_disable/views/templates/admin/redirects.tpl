...
<div class="elegantalBootstrapWrapper">
    <div class="panel elegantal_panel">
                                ...
                                <tr>
                                    <td>
                                        <a href="{$shop_url|escape:'html':'UTF-8'}{$model.old_url|escape:'html':'UTF-8'}" target="_blank">
                                            {$shop_url|escape:'html':'UTF-8'}{$model.old_url|truncate:25:'...'|escape:'html':'UTF-8'}
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{$model.new_url|escape:'html':'UTF-8'}" target="_blank">
                                            {$model.new_url|truncate:50:'...'|escape:'html':'UTF-8'}
                                        </a>
                                    </td>
        ...
        <div class="panel-footer clearfix">
            <a href="{$adminUrl|escape:'html':'UTF-8'}&event=redirectEdit" class="btn btn-success pull_right">
                <i class="process-icon-new"></i> {l s='Add New' mod='elegantalseoessentials'}
            </a>
            <a href="{$adminUrl|escape:'html':'UTF-8'}&event=redirectsImport" class="btn btn-default pull_right">
                <i class="process-icon-download"></i> {l s='Import' mod='elegantalseoessentials'}
            </a>
            <a href="{$adminUrl|escape:'html':'UTF-8'}&event=redirectsExport" class="btn btn-default pull_right">
                <i class="process-icon-upload"></i> {l s='Export' mod='elegantalseoessentials'}
            </a>
            {if $models}
                <a href="{$adminUrl|escape:'html':'UTF-8'}&event=redirectDeleteAll" class="btn btn-default pull_right" onclick="return confirm('{l s='Are you sure?' mod='elegantalseoessentials'}')">
