    ...
    public function renderHtml()
    {
        ...
        if (Tools::getValue('id_product') && Validate::isLoadedObject($product)) {
            ...
            if (preg_match("/{short_description[a-z\|]*}/", $html)) {
                $html = $this->replaceShortcode("/{short_description[a-z\|]*}/", htmlspecialchars($product->description_short, ENT_QUOTES), $html);
            }
            if (preg_match("/{long_description[a-z\|]*}/", $html)) {
                $html = $this->replaceShortcode("/{long_description[a-z\|]*}/", htmlspecialchars($product->description, ENT_QUOTES), $html);
            }
            ...
            if (preg_match("/{price_with_reduction_exc_tax[a-z\|]*}/", $html)) {
                $html = $this->replaceShortcode("/{price_with_reduction_exc_tax[a-z\|]*}/", ElegantalSeoEssentialsTools::displayPrice($price_with_reduction_exc_tax), $html);
            }
            if (preg_match("/{price_without_reduction_exc_tax[a-z\|]*}/", $html)) {
                $html = $this->replaceShortcode("/{price_without_reduction_exc_tax[a-z\|]*}/", ElegantalSeoEssentialsTools::displayPrice($price_without_reduction_exc_tax), $html);
            }
            if (preg_match("/{price_with_reduction_inc_tax[a-z\|]*}/", $html)) {
                $html = $this->replaceShortcode("/{price_with_reduction_inc_tax[a-z\|]*}/", ElegantalSeoEssentialsTools::displayPrice($price_with_reduction_inc_tax), $html);
            }
            if (preg_match("/{price_without_reduction_inc_tax[a-z\|]*}/", $html)) {
                $html = $this->replaceShortcode("/{price_without_reduction_inc_tax[a-z\|]*}/", ElegantalSeoEssentialsTools::displayPrice($price_without_reduction_inc_tax), $html);
            }
            if (preg_match("/{discount_percent[a-z\|]*}/", $html) && $price_without_reduction_exc_tax > 0) {
        ...
        if (Tools::getValue('id_category') && Validate::isLoadedObject($category)) {
            ...
            if (preg_match("/{category_description[a-z\|]*}/", $html)) {
                $html = $this->replaceShortcode("/{category_description[a-z\|]*}/", htmlspecialchars($category->description, ENT_QUOTES), $html);
            }
        ...
        if (Tools::getValue('id_manufacturer') && Validate::isLoadedObject($manufacturer)) {
            ...
            if (preg_match("/{manufacturer_short_description[a-z\|]*}/", $html)) {
                $html = $this->replaceShortcode("/{manufacturer_short_description[a-z\|]*}/", htmlspecialchars($manufacturer->short_description, ENT_QUOTES), $html);
            }
            if (preg_match("/{manufacturer_long_description[a-z\|]*}/", $html)) {
                $html = $this->replaceShortcode("/{manufacturer_long_description[a-z\|]*}/", htmlspecialchars($manufacturer->description, ENT_QUOTES), $html);
            }
