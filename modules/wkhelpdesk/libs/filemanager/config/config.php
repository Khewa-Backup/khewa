...
$upload_dir = _MODULE_DIR_.'wkhelpdesk/libs/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = _PS_ROOT_DIR_.'/modules/wkhelpdesk/libs/source/'; // relative path from filemanager folder to upload folder (with final /)

//thumbs folder can't put inside upload folder
$thumbs_base_path = _PS_ROOT_DIR_.'/modules/wkhelpdesk/libs/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$ext_file = array('doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai', 'kmz','dwg', 'dxf', 'hpgl', 'plt', 'spl', 'step', 'stp', 'iges', 'igs', 'sat', 'cgm', 'tiff'); //array('doc', 'docx','rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv','html','xhtml','psd','sql','log','fla','xml','ade','adp','mdb','accdb','ppt','pptx','odt','ots','ott','odb','odg','otp','otg','odf','ods','odp','css','ai'); //Files
$ext_video = array('mov', 'mpeg', 'm4v', 'mp4', 'avi', 'mpg', 'wma', "flv", "webm"); //Video
$ext_music = array('mp3', 'mpga', 'm4a', 'ac3', 'aiff', 'mid', 'ogg', 'wav'); //array('mp3', 'm4a', 'ac3', 'aiff', 'mid','ogg','wav'); //Audio
$ext_misc = array('zip', 'rar', 'gz', 'tar', 'iso', 'dmg'); // array('zip', 'rar','gz','tar','iso','dmg'); //Archives
...
$fixed_image_creation_height            = array(200,300); //height of image (you can leave empty if you set width)
...
$relative_image_creation_height         = array(200,300); //height of image (you can leave empty if you set width)
