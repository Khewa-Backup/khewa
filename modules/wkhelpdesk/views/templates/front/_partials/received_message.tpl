...
<div class="row" style="margin-bottom: 20px;">
    <div class="col-xs-1 wk_hd_others_name_div" style="width:60px;">
        <div class="wk_hd_name_initial" style="background:#C8DFFD;">
            <p class="h4" style="line-height:30px;color:#2483EF;text-align:center;">{$name|substr:0:1}</p>
        </div>
    </div>
    <div class="col-xs-8 col-sm-9 wk_hd_msg_div">
    ...
    <div class="row">
        ...
        <div class="col-xs-8 col-sm-9">
            <span class="wk_hd_datetime_received text-muted" style="display:block;"><i>{$name}</i>, {$ticket_msg.date_add|date_format:"%d-%b-%Y"}, {$ticket_msg.date_add|date_format:"%r"|substr:0:11}</span>
        </div>
    </div>
</div>