...
namespace CanadaPost\Symfony\Component\OptionsResolver;

use CanadaPost\Symfony\Component\OptionsResolver\Exception\AccessException;
use CanadaPost\Symfony\Component\OptionsResolver\Exception\InvalidOptionsException;
use CanadaPost\Symfony\Component\OptionsResolver\Exception\MissingOptionsException;
use CanadaPost\Symfony\Component\OptionsResolver\Exception\NoSuchOptionException;
use CanadaPost\Symfony\Component\OptionsResolver\Exception\OptionDefinitionException;
use CanadaPost\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException;
...
class OptionsResolver implements Options
{
    ...
    public function offsetGet($option)
    {
        ...
        if (isset($this->allowedTypes[$option])) {
            ...
            if (!$valid) {
                ...
                if (1 === \count($keys) && '[]' === \Tools::substr($keys[0], -2)) {
    ...
    {
        if (\is_array($value) && '[]' === \Tools::substr($type, -2)) {
