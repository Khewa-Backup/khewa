...
namespace CanadaPost\BoxPacker;

use CanadaPost\Psr\Log\LoggerAwareInterface;
use CanadaPost\Psr\Log\LoggerAwareTrait;
use CanadaPost\Psr\Log\NullLogger;
        ...
        while (!$this->items->isEmpty()) {
            ...
            if ($orientatedItem instanceof OrientatedItem) {
                ...
                if ($layerWidth == 0 && $layerDepth == 0) { // zero items on layer
                    ...
                    $layerWidth = max($layerWidth, $rowWidth);
                    $layerLength += $rowLength;
                    $packingWidthLeft = $rowWidth ? min((int)($layerWidth * 1.1), $this->boxWidth) : $this->boxWidth;
                    $packingLengthLeft = $rowLength ? min((int)($layerLength * 1.1), $this->boxLength) : $this->boxLength;
