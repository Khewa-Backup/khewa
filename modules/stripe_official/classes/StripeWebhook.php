...
class StripeWebhook
{
    ...
    public function updateStripeWebhook($webhookId)
    {
        ...
        try {
            ...
            StripeProcessLogger::logInfo('Retrieve Stripe Webhook Error => ' . $e->getMessage() . ' - ' . $e->getTraceAsString(), 'StripeWebhook');
        }
    ...
    private function retrieveWebhookEndpoints($webhookId)
    {
        ...
        try {
            ...
            StripeProcessLogger::logInfo('Could not Retrieve Stripe Webhook => ' . $e->getMessage() . ' - ' . $e->getTraceAsString(), 'StripeWebhook');
        }
