...
class StripePaymentIntent extends ObjectModel
{
    ...
    public const STATUS_OUTOFSTOCK_PAID = '9'; // Backorder Paid
    public const STATUS_OUTOFSTOCK_UNPAID = '10'; // Backorder Not Paid
    ...
    public function getPsStatus()
    {
        ...
        switch ($this->status) {
            ...
            case self::STATUS_PARTIALLY_REFUNDED:
                ...
                break;
            case self::STATUS_OUTOFSTOCK_PAID:
                $status = Configuration::get('PS_OS_OUTOFSTOCK_PAID');
                break;
            case self::STATUS_OUTOFSTOCK_UNPAID:
                $status = Configuration::get('PS_OS_OUTOFSTOCK_UNPAID');
                break;
        }
