...
class CartContextModel
{
     ...
     * @param string $phone
     * @param string $cartSecureKey
     */
    public function __construct($psCurrency, $currencyIsoCode, $cartId, $psCart, $amount, $orderId, $psOrder, $customerModel, $psCustomer, $reference, $psLanguage, $phone, $cartSecureKey)
    {
        ...
        $this->phone = $phone;
        $this->cartSecureKey = $cartSecureKey;
    }
    ...
    public static function getFromContext($context): self
    {
        ...
        $cartSecureKey = $psCart->secure_key;

        return new self($psCurrency, $currencyIsoCode, $cartId, $psCart, $amount, $orderId, $psOrder, $customerModel, $psCustomer, $reference, $psLanguage, $phone, $cartSecureKey);
    }
}
