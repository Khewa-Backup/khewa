...
class BuildContextAction extends BaseAction
{
    public function execute()
    {
        ...
        $this->module->getContext()->smarty->assign([
            ...
            'extended_logging' => \Configuration::get(\Stripe_official::ENABLE_EXTENDED_LOGGING, null, $shopGroupId, $shopId),
            'is_cloudsync_enabled' => $this->module->isCloudSyncEnabled(),
        ]);
    ...
    protected function assignSmartyVars()
    {
        ...
        $this->module->getContext()->smarty->assign([
            ...
            'klarna_button_theme' => \Configuration::get(\Stripe_official::KLARNA_BUTTON_THEME, null, $shopGroupId, $shopId),
            'klarna_button_type' => \Configuration::get(\Stripe_official::KLARNA_BUTTON_TYPE, null, $shopGroupId, $shopId),
            ...
            'extended_logging' => \Configuration::get(\Stripe_official::ENABLE_EXTENDED_LOGGING, null, $shopGroupId, $shopId),
            'enable_apple_pay' => \Configuration::get(\Stripe_official::ENABLE_APPLE_PAY, null, $shopGroupId, $shopId),
            'enable_google_pay' => \Configuration::get(\Stripe_official::ENABLE_GOOGLE_PAY, null, $shopGroupId, $shopId),
            'enable_pay_pal' => \Configuration::get(\Stripe_official::ENABLE_PAY_PAL, null, $shopGroupId, $shopId),
            'enable_klarna_express' => \Configuration::get(\Stripe_official::ENABLE_KLARNA_EXPRESS, null, $shopGroupId, $shopId),
            'enable_amazon_pay' => \Configuration::get(\Stripe_official::ENABLE_AMAZON_PAY, null, $shopGroupId, $shopId),
            'enable_link_express' => \Configuration::get(\Stripe_official::ENABLE_LINK_EXPRESS, null, $shopGroupId, $shopId),
        ]);
    }
