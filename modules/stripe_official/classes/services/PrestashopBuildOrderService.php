...
class PrestashopBuildOrderService
{
        ...
        ?string $stripePaymentMethodId = null): OrderModel
    {
        ...
        StripeProcessLogger::logInfo('Build order model ' . json_encode($orderModel), 'PrestashopBuildOrderService', $cartContextModel->cartId);

        $orderModel = $this->prestashopOrderService->createPsOrder($orderModel);
        StripeProcessLogger::logInfo('Create order model ' . json_encode($orderModel), 'PrestashopBuildOrderService', $cartContextModel->cartId);
