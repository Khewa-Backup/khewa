...
<div class="panel-heading">
    ...
    &nbsp;{l s='Our modules' mod='ntbackupandrestore'}
</div>
<div class="our_modules">
            ...
            {if $module.link}
                <div class="nt_module panel">
                    ...
                    <a href="{$module.link|escape:'html':'UTF-8'}" target="_blank">
                        <img class="nt_logo" src="../modules/ntbackupandrestore/views/img/{$module.logo|escape:'html':'UTF-8'}" alt="2N Technologies"/>
                    </a>
                    <br/>
                    <br/>
    ...
    <p>
        <a target="_blank" href="https://addons.prestashop.com/fr/2_community-developer?contributor=311046">
            <i class="fas fa-external-link-alt"></i> {l s='See all our modules on the Addons Marketplace' mod='ntbackupandrestore'}
        </a>
    </p>
</div>
