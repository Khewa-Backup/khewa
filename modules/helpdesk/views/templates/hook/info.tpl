...
<div class="panel" id="fmm_promo_panel">
  <div class="col-lg-3">
    <ul>
      <li><a href="{$smarty.const.__PS_BASE_URI__|escape:'htmlall':'UTF-8'}modules/helpdesk/readme_en.pdf" target="_blank" title="Need Help">{if Tools::version_compare(_PS_VERSION_, '1.7.0.0', '>=') > 0}<i class="material-icons">&#xE887;</i>{else}<i class="icon-question-circle"></i>{/if}Help?</a></li>
      <li class="color_red"><a href="https://addons.prestashop.com/contact-form.php?id_product=18740" target="_blank" title="Need Support">{if Tools::version_compare(_PS_VERSION_, '1.7.0.0', '>=') > 0}<i class="material-icons">&#xE0C6;</i>{else}<i class="icon-comments"></i>{/if}Support</a></li>
      <li class="color_blue"><a href="https://addons.prestashop.com/en/customer-service/18740-help-desk-customer-support-management-system.html" target="_blank" title="Need Details">{if Tools::version_compare(_PS_VERSION_, '1.7.0.0', '>=') > 0}<i class="material-icons">&#xE8F4;</i>{else}<i class="icon-eye"></i>{/if}Details</a></li>
  ...
  <div class="col-lg-7 fmm_promo_modules">
    <ol>
      ...
      <li><a href="https://addons.prestashop.com/en/additional-information-product-tab/44085-restrict-products-category-cms-by-customer-groups.html" target="_blank" title="Custom Fields"><img src="https://www.fmemodules.com/2160-home_default/restrict-by-customer-groups-products-category-cms.jpg" alt="" /><i>Restrict by Customer Groups Module</i></a></li>
      <li><a href="https://addons.prestashop.com/en/private-sales-flash-sales/20141-private-shop-login-to-see-products-store.html" target="_blank" title="Private Shop"><img src="https://www.fmemodules.com/2059-home_default/private-shop.jpg" alt="" /><i>Private Shop Module</i></a></li>
    </ol>
  </div>
