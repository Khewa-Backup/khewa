...
<form action="{$link->getModuleLink('helpdesk', 'helpdesk')|escape:'htmlall':'UTF-8'}" method="post" id="add_ticket" name="helpdesk_form" enctype="multipart/form-data" class="std">
		...
		<div class="form-group">
        	...
        	<p class="submit2">
				...
				<input type="submit" class="button DataTrigger_test btn btn-primary" value="{l s='Post Ticket' mod='helpdesk'}" id="submitAddress" style="display:none"  name="submitAddress">
			</p>
			<p>&nbsp;</p>
			{else}
			<p class="submit2">
