...
class AmazzingFilter extends Module
{
        ...
        switch ($action) {
            ...
            case 'prepareParams':
                    ...
                    if (!empty($params['in_stock'])) {
                        ...
                        $ret['reset_a'] = $ret['check_combinations'] = true;
    ...
    */
    ...
    public function ajaxUpdateHook()
    {
        ...
        $default_hook_layouts = $pages_without_this_hook = $warning = [];
        ...
        if ($default_hook_layouts[$new_hook] != $default_hook_layouts[$previous_hook]) {
            ...
            foreach ($this->shop_ids as $id_shop) {
                ...
                $this->saveSettings('general', $settings, [$id_shop]);
            }
    ...
    */
    ...
    {
        $compact_order_names = ['name' => 'n', 'date_add' => 'd', 'reference' => 'r', 'price' => 'p'];
