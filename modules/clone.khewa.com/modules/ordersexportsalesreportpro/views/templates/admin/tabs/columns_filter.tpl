        ...
        <fieldset class="col-xs-7 pull-right">
            ...
            <div id="data_export_orders_scroll_columns" class="overflowable">
                ...
                <ul id="data_export_orders_product_columns" class="list-group item-list data_export_columns hidden">
                    ...
                    <li class="list-group-item product"><i class="icon-check-square-o" data-value="order_details_tax.rt"></i> {l s='Tax Rate' mod='ordersexportsalesreportpro'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                    <li class="list-group-item product"><i class="icon-check-square-o" data-value="order_details_tax.uat"></i> {l s='Tax of Unit Amount' mod='ordersexportsalesreportpro'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
                    <li class="list-group-item product"><i class="icon-check-square-o" data-value="order_details_tax.tat"></i> {l s='Tax of Total Amount' mod='ordersexportsalesreportpro'}<span class="pull-right ui-icon ui-icon-arrowthick-2-n-s"></span></li>
