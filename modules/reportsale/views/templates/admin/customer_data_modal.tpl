...
{if $customer|@count >=1}
	...
	{foreach from=$customer item=c}
		<li>
			...
			<span class="reportsale_name">{$c.first_name|escape:'htmlall':'UTF-8'} {$c.last_name|escape:'htmlall':'UTF-8'}</span>
			<span> ({$c.total_order|escape:'htmlall':'UTF-8'} {l s='Orders' mod='reportsale'})</span>
			</a>
		</li>
	{/foreach}
	<ol>
