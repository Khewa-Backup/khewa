                ...
                <div class="col-lg-8">
                    <div class="form-inline order_date">
                        ...
                        <div class="form-group">
                            ...
                            <select class="reportsale_range" rev="order_date" name="PR_range_orderdate">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="form-inline invoice_date">
                        ...
                        <div class="form-group">
                            <label>{l s='Range' mod='reportsale'}</label>
                            <select class="reportsale_range" rev="invoice_date" name="PR_range_invoicedate">
                                <option value="1">{l s='Custom Date' mod='reportsale'}</option>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="form-inline delivery_date">
                        ...
                        <div class="form-group">
                            <label>{l s='Range' mod='reportsale'}</label>
                            <select class="reportsale_range" rev="delivery_date" name="PR_range_deliverydate">
                                <option value="1">{l s='Custom Date' mod='reportsale'}</option>
