...
<?php
			...
			?>
<div class="ce-countdown ce-countdown--theme-7" id="ce-countdown">
    <div class="cont <?php echo $somplete_class; ?>">
        <div class="text">
            <h2><?php echo $completed_text; ?></h2>
        </div>
...
<?php
			...
			?>
<div class="ce-countdown ce-countdown--theme-2 ce-clearfix" id="ce-countdown">
...
<?php
			...
			?>
<div class="ce-countdown ce-countdown--theme-6" id="ce-countdown">
    <div class="cont <?php echo $somplete_class; ?>">
        <div class="text">
            <h2><?php echo $completed_text; ?></h2>
        </div>
...
<?php
			...
			?>
<div class="ce-countdown ce-countdown--theme-9" id="ce-countdown">
    <div class="cont <?php echo $somplete_class; ?>">
        <div class="text">
            <h2><?php echo $completed_text; ?></h2>
        </div>
