...
class Widget_ProductSingleTitle extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        if ($controller_name == "product") {
            ...
            $out_put .= \Context::getcontext()->smarty->fetch(_PS_MODULE_DIR_ . 'crazyelements/views/templates/front/crazy_single_product_title.tpl');
            echo $out_put;
        } else {
            $out_put = "<h1 class=\"crazy_single_product_heading h1\" itemprop=\"name\">Product Title</h1>";
            echo $out_put;
        }
    }
