...
<div class="payment_module stripe-payment-17" >
     <div id="stripe-ajax-loader"><img src="{$module_dir|escape:'htmlall':'UTF-8'}views/img/ajax-loader.gif" alt="" /> {l s='Do not press BACK or REFRESH while processing...' mod='stripejs'}</div>
     <div id="stripe-translations">
      ...
      <form action="#" id="stripe-payment-form">
        {if $secure_mode==1}
        <img class="dsecure" alt="3dsecure" src="{$module_dir|escape:'htmlall':'UTF-8'}views/img/3Dsecure.png"/>
        {/if}
        ...
        <div>
          <label>{l s='Cardholder\'s Name' mod='stripejs'}</label>  <label class="required"> </label>
...
<div id="modal_stripe"  class="modal" style="display: none">
  <div id="close_secure" class="close" style="display:none;">X</div>
