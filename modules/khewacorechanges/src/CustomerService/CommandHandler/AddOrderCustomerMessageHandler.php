<?php
/**
 * khewacorechanges — copy of the customized core command handler
 * (see CORE_CHANGES.md #11 "Also found" section). Wired in through
 * config/services.yml, which re-declares the core service id with this
 * class, so the customization survives core updates.
 * Below this header the file is identical to the customized core file.
 */
...
namespace KhewaCoreChanges\CustomerService\CommandHandler;
