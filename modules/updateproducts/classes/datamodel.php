...
class productsUpdateModel
{
    ...
    $separatedCategories = false)
  {
    ...
    $products_check = updateProductTools::jsonDecode(Configuration::get('GOMAKOIL_PRODUCTS_CHECKED',null,$shopGroupId, $idShop));
    $selected_manufacturers = updateProductTools::jsonDecode(Configuration::get('GOMAKOIL_MANUFACTURERS_CHECKED',null,$shopGroupId, $idShop));
    $selected_suppliers = updateProductTools::jsonDecode(Configuration::get('GOMAKOIL_SUPPLIERS_CHECKED',null,$shopGroupId, $idShop));
    $selected_categories = updateProductTools::jsonDecode(Configuration::get('GOMAKOIL_CATEGORIES_CHECKED',null,$shopGroupId, $idShop));
    $where = "";
    $justProducts = true;
  ...
  public function getIdsOfProductsForExport( $idShop, $idLang, $shopGroupId, $separate , $more_settings, $limit, $limitN)
  {
    if( !$limit ){
      $limit = " LIMIT 0,".(int)$limitN." ";
    } else {
