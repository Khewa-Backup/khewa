	...
	<div class="form-group">
		...
		<div class="col-lg-9">
			<span class="switch prestashop-switch fixed-width-lg">
				<input type="radio" name="cron_active" id="cron_active_on" value="1" {if $cron_active}checked="checked"{/if} />
				<label class="t" for="cron_active_on">{l s='Yes' mod='thegiftcard'}</label>
				<input type="radio" name="cron_active" id="cron_active_off" value="0" {if !$cron_active}checked="checked"{/if} />
			...
			<div class="alert alert-info cron-task">
				...
				<ul class="list-unstyled">
					<li><code>0 * * * * curl {if Configuration::get('PS_SSL_ENABLED')}-k{/if} "{$cron_url|escape:'html':'UTF-8'}"</code></li>
				</ul>
			</div>
		</div>
	</div>
