...
use ETSHybridauth\Exception\AuthorizationDeniedException;
use ETSHybridauth\Exception\InvalidOauthTokenException;
use ETSHybridauth\Exception\InvalidAccessTokenException;
use ETSHybridauth\Data;
use ETSHybridauth\HttpClient;
use ETSHybridauth\Thirdparty\OAuth\OAuthConsumer;
use ETSHybridauth\Thirdparty\OAuth\OAuthRequest;
use ETSHybridauth\Thirdparty\OAuth\OAuthSignatureMethodHMACSHA1;
use ETSHybridauth\Thirdparty\OAuth\OAuthUtil;
...
abstract class OAuth1 extends AbstractAdapter implements AdapterInterface
{
    ...
    * ETSHybridauth will consider any HTTP status code that is different than '200 OK' as an ERROR.
    *
    * @param string $url
    * @param string $method
    * @param array $parameters
