...
use ETSHybridauth\Exception\NotImplementedException;
use ETSHybridauth\Exception\InvalidArgumentException;
use ETSHybridauth\Exception\HttpClientFailureException;
use ETSHybridauth\Exception\HttpRequestFailedException;
use ETSHybridauth\Storage\StorageInterface;
use ETSHybridauth\Storage\Session;
use ETSHybridauth\Logger\LoggerInterface;
use ETSHybridauth\Logger\Logger;
use ETSHybridauth\HttpClient\HttpClientInterface;
use ETSHybridauth\HttpClient\Curl as HttpClient;
...
abstract class AbstractAdapter extends AbstractDataStore implements AdapterInterface
{
    ...
    */
    ...
    {
        $this->storage = $storage ?: new Session($this->context);
    }
