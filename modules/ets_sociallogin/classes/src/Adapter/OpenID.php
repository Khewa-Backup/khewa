...
use ETSHybridauth\Exception\InvalidOpenidIdentifierException;
use ETSHybridauth\Exception\AuthorizationDeniedException;
use ETSHybridauth\Exception\InvalidOpenidResponseException;
...
use ETSHybridauth\Thirdparty\OpenID\LightOpenID;
...
abstract class OpenID extends AbstractAdapter implements AdapterInterface
{
    ...
    */
    ...
    {
        return (bool) $this->getStoredData('user');
    }
    ...
    */
    protected function authenticateFinish()
    {
        ...
        $this->storeData('user', $userProfile);
    }
    ...
    */
    ...
    {
        $userProfile = $this->getStoredData('user');
