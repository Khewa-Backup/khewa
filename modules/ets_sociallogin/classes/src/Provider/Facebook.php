 ...
 *   ];
 *
 *   $adapter = new ETSHybridauth\Provider\Facebook( $config );
 *
 *   try {
 ...
 *       $response = $adapter->setUserStatus("ETSHybridauth test message..");
 *   }
 *   catch( Exception $e ){
 *       echo $e->getMessage() ;
 *   }
...
class Facebook extends OAuth2
{
     ...
     *
     * @return \ETSHybridauth\User\Profile
     */
     ...
     * @param array $item
     *
     * @return \ETSHybridauth\User\Contact
     */
