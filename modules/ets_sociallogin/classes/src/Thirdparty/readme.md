...
Here we include a number of third party libraries. Those libraries are used by the various providers supported by ETSHybridauth.
...
Notes: 
    ...
    Both LightOpenID and OAuth are (to be) partially/indirectly tested within the ETSHybridauth library. 
